...
export class Backend implements backendInterface {
    ...
    async getRecentSessions(): Promise<Array<Session>> {
        if (this.processError) {
            try {
                const result = await this.actor.getRecentSessions();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getSessionsForSubject(arg0: bigint): Promise<Array<Session>> {
        if (this.processError) {
            try {
                const result = await this.actor.getSessionsForSubject(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getSubjectStats(arg0: bigint): Promise<SubjectStats> {
        if (this.processError) {
            try {
                const result = await this.actor.getSubjectStats(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async logSession(arg0: bigint, arg1: string, arg2: bigint, arg3: bigint, arg4: string): Promise<bigint> {
        if (this.processError) {
            try {
                const result = await this.actor.logSession(arg0, arg1, arg2, arg3, arg4);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
